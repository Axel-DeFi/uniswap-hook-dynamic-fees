...
contract RunFullValidationSepolia is Script {
    using PoolIdLibrary for PoolKey;
    using StateLibrary for IPoolManager;

    function run() external {
        LoggingLib.phase("sepolia.full");
        ...
        string memory reportPath = vm.envOr(
            "OPS_SEPOLIA_FULL_REPORT",
            string.concat(vm.projectRoot(), "/ops/sepolia/out/reports/full.sepolia.json")
        );
