...
- `out/` — script outputs and Foundry artifacts (kept out of the project root)
...
- Foundry build artifacts are written under `./scripts/out/foundry` (see `foundry.toml`) to keep the project root clean.
